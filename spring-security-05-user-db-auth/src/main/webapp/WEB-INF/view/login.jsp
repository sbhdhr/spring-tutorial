		...
		<div class="container-login100">
			<div class="wrap-login100">
				<form:form class="login100-form validate-form" 
							action="${pageContext.request.contextPath}/authenticateUser" method="post">
					...
					<div class="container-login100-form-btn">
						...
						<c:if test="${param.error != null}">
							<br><br>
							<p class="txt1 p-t-20" style="color:red;">
								Invalid credentials
							</p>
						...
						<c:if test="${param.logout != null}">
							<br><br>
							<p class="txt1 p-t-20" style="color:green;">
				...
				<div class="login100-more" style="background-image: url('<%=request.getContextPath()%>/resources/images/bg-01.jpg');">
				</div>
			</div>
		</div>
	</div>
